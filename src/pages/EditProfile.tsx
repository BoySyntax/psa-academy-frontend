...
const EditProfile = ({ user, onNavigate }: EditProfileProps) => {
  ...
  const handleSave = async () => {
    setSaving(true);
    const result = await profileService.updateProfile(user.id.toString(), form);
    setSaving(false);
    if (result.success) {
      if (result.profile) {
        setForm(result.profile);
          ...
          <Accordion type="multiple" className="w-full space-y-2">
              ...
              <AccordionContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                  ...
                  <div>
                    ...
                    <Select value={form.civil_status || ""} onValueChange={(v) => update("civil_status", v)}>
                      <SelectTrigger className="mt-1">
                  ...
                  <div>
                    ...
                    <Select value={form.type_of_disability || ""} onValueChange={(v) => update("type_of_disability", v)}>
                      <SelectTrigger className="mt-1">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <Select value={form.educational_attainment || ""} onValueChange={(v) => update("educational_attainment", v)}>
                      <SelectTrigger className="mt-1">
            ...
            <AccordionItem value="address">
              ...
              <AccordionContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                  <div className="md:col-span-2">
                    <label className="text-sm font-medium">House No. and Street</label>
                    <Input
                      className="mt-1"
              ...
              <AccordionContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                  <div>
                    ...
                    <Select value={form.type_of_employment || ""} onValueChange={(v) => update("type_of_employment", v)}>
                      <SelectTrigger className="mt-1">
                  ...
                  <div>
                    ...
                    <Select value={form.civil_service_eligibility_level || ""} onValueChange={(v) => update("civil_service_eligibility_level", v)}>
                      <SelectTrigger className="mt-1">
